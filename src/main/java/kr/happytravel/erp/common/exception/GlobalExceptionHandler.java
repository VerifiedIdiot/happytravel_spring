...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<String> handleSQLException(SQLException ex, WebRequest request) {
		...
		return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("SQL error in DB occurred: " + ex.getMessage());
	}
	...
	public ResponseEntity<String> handleMySQLSyntaxErrorException(MySQLSyntaxErrorException ex) {
		...
		return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("MySQLSyntax Error occurred: " + ex.getLocalizedMessage());
	}
	...
	public ResponseEntity<String> handleNullPointerException(NullPointerException ex) {
		...
		return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("Null pointer exception occurred: " + ex.getLocalizedMessage());
	}
	...
	public ResponseEntity<String> handleIllegalArgumentException(IllegalArgumentException ex) {
		...
		return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Invalid argument: " + ex.getLocalizedMessage());
	}
	...
	public ResponseEntity<String> handleMethodArgumentTypeMismatchException(MethodArgumentTypeMismatchException ex) {
		...
		return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Parameter type mismatch: " + ex.getName() + " requires type " + ex.getRequiredType().getSimpleName());
	}
	...
	public ResponseEntity<String> handleAccessDeniedException(AccessDeniedException ex) {
		...
		return ResponseEntity.status(HttpStatus.FORBIDDEN).body("Access denied: " + ex.getLocalizedMessage());
	}
	...
	public ResponseEntity<String> handleJsonProcessingException(JsonProcessingException ex, WebRequest request) {
		...
		return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("JSON processing error: " + ex.getOriginalMessage());
	}
	...
	public ResponseEntity<String> handleHttpMessageNotReadableException(HttpMessageNotReadableException ex) {
		...
		return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Request body is unreadable: " + ex.getLocalizedMessage());
	}
